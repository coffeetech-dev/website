                    ...
                    <main className="col-lg-8">
                        <div className="single-blog-content">
                            <div className="feature-img">
                                ...
                                <img src="/assets/images/thumbs/single-blog-img.png" alt=""/>
                            </div>
                            ...
                            <div className="author-card">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/post-author.png" alt=""/>
                                </div>
                            ...
                            <div className="post-gallery">
                                <div className="image-slider-s1">
                                    <SliderCom settings={settings}>
                                        <div className="item">
                                            <img
                                                src="/assets/images/thumbs/post-gallery-img1.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="item">
                                            <img
                                                src="/assets/images/thumbs/post-gallery-img2.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="item">
                        ...
                        <div className="more-post-section">
                            <div className="post prev">
                                <div className="thumb">
                                    <img
                                        src="/assets/images/blog-post/more-post-thumb-1.png"
                                        alt=""
                                    />
                                </div>
                                <div className="content">
                                    <p>Cupidatat non proident sunt culpa officia</p>
                                    <Link href="#"><i className="fa-solid fa-arrow-left"></i>Previous</Link>
                                </div>
                            </div>
                            <div className="post next">
                                <div className="thumb">
                                    <img
                                        src="/assets/images/blog-post/more-post-thumb-2.png"
                                        alt=""
                                    />
                                </div>
                                <div className="content">
                                    <p>The start-up ultimate uuide to make your wordpress</p>
                                    <Link href="#">Next<i className="fa-solid fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="all-comments">
                                <div className="s-comment">
                                    <div className="s-comment-inner">
                                        <div className="thumb">
                                            <img
                                                src="/assets/images/thumbs/comment-thumb1.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="content">
                                ...
                                <div className="s-comment">
                                    <div className="s-comment-inner">
                                        <div className="thumb">
                                            <img
                                                src="/assets/images/thumbs/comment-thumb2.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="content">
                                    ...
                                    <div className="s-comment">
                                        <div className="s-comment-inner">
                                            <div className="thumb">
                                                <img
                                                    src="/assets/images/thumbs/comment-thumb3.png"
                                                    alt=""
                                                />
                                            </div>
                                            <div className="content">
                    ...
                    <aside className="col-lg-4">
                        <div className="blog-sidebar-s1">
                            <div className="featured-author-widget widget">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/blog-author.png" alt=""/>
                                </div>
                                <div className="content">
                            ...
                            <div className="latest-posts-widget widget">
                                ...
                                <div className="recent-posts">
                                    <div className="rp-single">
                                        ...
                                        <div className="content">
                                            <h4>
                                                <Link href="#">Thoughtful man using laptop pondering </Link>
                                            </h4>
                                            <span
                        ...
                        2022</span
                                    ...
                                    <div className="rp-single">
                                        ...
                                        <div className="content">
                                            <h4>
                                                <Link href="#">Young man with a lap top in a business</Link>
                                            </h4>
                                            <span
                                            ><i className="fa-solid fa-calendar-days"></i>23 May
                        2022</span
                        ...
                        2022</span
                            ...
                            <div className="popular-tags-widget widget">
                                ...
                                <div className="tags-container">
                                    <Link href="#" className="tag">Agency</Link>
                                    <Link href="#" className="tag">Creative</Link>
                                    <Link href="#" className="tag">Data</Link>
                                    <Link href="#" className="tag">Technology</Link>
                                    <Link href="#" className="tag">Development</Link>
                                    <Link href="#" className="tag">Business</Link>
                                    <Link href="#" className="tag">Idea</Link>
                                    <Link href="#" className="tag">Generic</Link>
                                </div>
                            </div>
