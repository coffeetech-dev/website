                ...
                <div className="row">
                    <main className="col-lg-8 portfolio-detail__main">
                        <div className="feature-img">
                            <img
                                src="/assets/images/portfolio-thumb/single-portfolio.png"
                                alt=""
                            />
                        </div>
                        ...
                        <div className="image-slider-s1">
                            <SliderCom settings={settings}>
                                <div className="item">
                                    <img
                                        src="/assets/images/portfolio-thumb/portfollio-s1.png"
                                        alt=""
                                    />
                                </div>
                                <div className="item">
                                    <img
                                        src="/assets/images/portfolio-thumb/portfollio-s2.png"
                                        alt=""
                                    />
                                </div>
                                <div className="item">
