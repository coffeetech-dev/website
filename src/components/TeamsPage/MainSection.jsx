...
function MainSection() {
    return (
        <section className="team-area-s2 s-padding">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            ...
                            <div className="content">
                                <h3 className="name">
                                    <Link href="/team-details">Deniella Rhodes</Link>
                                </h3>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            ...
                            <div className="content">
                                <h3 className="name">
                                    <Link href="/team-details">David Phillips</Link>
                                </h3>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            ...
                            <div className="content">
                                <h3 className="name">
                                    <Link href="/team-details">Lauren Davison</Link>
                                </h3>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            ...
                            <div className="content">
                                <h3 className="name">
                                    <Link href="/team-details">Druid Wensleydale</Link>
                                </h3>
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            <div className="thumb">
                                <img src="/assets/images/thumbs/about-team-5.png" alt=""/>
                                <ul className="social-icons-s1">
                                    <li>
                                        <Link href="https://www.facebook.com/QuomodoSoft"
                                        ><i className="fa-brands fa-facebook-f"></i
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            <div className="thumb">
                                <img src="/assets/images/thumbs/about-team-6.png" alt=""/>
                                <ul className="social-icons-s1">
                                    <li>
                                        <Link href="https://www.facebook.com/QuomodoSoft"
                                        ><i className="fa-brands fa-facebook-f"></i
                            ...
                            <div className="content">
                                <h3 className="name"><Link href="/team-details">Jane Cooper</Link></h3>
                                <p className="designation">Support Expert</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            <div className="thumb">
                                <img src="/assets/images/thumbs/about-team-7.png" alt=""/>
                                <ul className="social-icons-s1">
                                    <li>
                                        <Link href="https://www.facebook.com/QuomodoSoft"
                                        ><i className="fa-brands fa-facebook-f"></i
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-team-s2">
                            <div className="thumb">
                                <img src="/assets/images/thumbs/about-team-8.png" alt=""/>
                                <ul className="social-icons-s1">
                                    <li>
                                        <Link href="https://www.facebook.com/QuomodoSoft"
                                        ><i className="fa-brands fa-facebook-f"></i
                            ...
                            <div className="content">
                                <h3 className="name"><Link href="/team-details">Guy Hawkins</Link></h3>
