                ...
                <div className="row">
                    <div className="col-xl-4 col-md-6 floating">
                        ...
                        >
                            ...
                            <div className="content">
                                <h4><Link href="/pricing">Cloud Solutions</Link></h4>
                                <p>
                    ...
                    <div className="col-xl-4 col-md-6">
                        ...
                        >
                            ...
                            <div className="content">
                                <h4><Link href="/pricing">Cyber Security</Link></h4>
                                <p>
                                    There are many variatons of passtai of Lorem Ipsum available,
                                    but the as jority have suffered
                                </p>
                    ...
                    <div className="col-xl-4 col-lg-6 d-lg-none">
                        ...
                        >
                            ...
                            <div className="content">
                                <h4><Link href="/service-details">Product & Design</Link></h4>
                                <p>
                                    There are many variatons of passtai of Lorem Ipsum available,
                                    but the as jority have suffered
                                </p>
                    ...
                    <div className="col-xl-4 col-lg-6 d-lg-none">
                        ...
                        >
                            ...
                            <div className="content">
                                <h4><Link href="/service-details">Analytic Solutions</Link></h4>
                                <p>
                                    There are many variatons of passtai of Lorem Ipsum available,
                                    but the as jority have suffered
                                </p>
