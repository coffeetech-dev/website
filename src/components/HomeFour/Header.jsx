...
function Header() {
    return (
        <header className="header-s4">
            <div className="header-container">
                <div className="header-top-container">
                    <div className="container">
                        <div className="header-s3__top">
                            <div className="p-left">
                                <div className="tb-single-info-s4">
                                    <div className="icon">
                ...
                <div className="header-bottom-container">
                    <div className="container">
                        <div className="header-s4__bottom">
                            <div className="p-left">
                                <div className="logo">
                                    <Link href="/home-four">
                                        <img src="/assets/images/logos/logo-home-4.svg" alt="logo"/>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="p-right">
                                <Link href="/service" className="btn btn-s4">Start a Project</Link>
                            </div>
                        </div>
                    </div>
                </div>
