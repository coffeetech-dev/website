                        ...
                        <div className="about-s4__content about-s9__content">
                            ...
                            <div className="content-b">
                                <div className="i-box">
                                    <div className="icon">
                                        <img
                                            src="/assets/images/feature-icons/globe-icon-white.png"
                                            alt=""
                                        />
                                    </div>
                                ...
                                <div className="i-box">
                                    <div className="icon">
                                        <img
                                            src="/assets/images/feature-icons/network-icon-white.png"
                                            alt=""
                                        />
                                    </div>
                            ...
                            <Link href="/service-details" className="btn btn-s4">Learn More</Link>
                        </div>
                    </div>
                    <div className="col-xl-5 col-lg-6">
                        <div className="about-s9__thumb">
                            <img src="/assets/images/thumbs/about9-t1.png" alt="about"/>
                        </div>
                    </div>
                </div>
            </div>
