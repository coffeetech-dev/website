            ...
            <div className="container">
                <div className="funfact-area-s6-container funfact-area-s2-container">
                    <div className="funfact-s4 funfact-s2">
                        <div className="icon">
                            <img src="/assets/images/feature-icons/projects2.svg" alt=""/>
                        </div>
                ...
                ><span className="s-fix">+</span>
                    ...
                    <div className="funfact-s4 funfact-s2">
                        <div className="icon">
                            <img src="/assets/images/feature-icons/clients2.svg" alt=""/>
                        </div>
                        <div className="content">
                            <h4>
                ...
                ><span className="s-fix">+</span>
                    ...
                    <div className="funfact-s4 funfact-s2">
                        <div className="icon">
                            <img src="/assets/images/feature-icons/years2.svg" alt=""/>
                        </div>
                        <div className="content">
                            <h4>
                ...
                ><span className="s-fix">+</span>
                    ...
                    <div className="funfact-s4 funfact-s2">
                        <div className="icon">
                            <img src="/assets/images/feature-icons/win2.svg" alt=""/>
                        </div>
                        <div className="content">
                            <h4>
