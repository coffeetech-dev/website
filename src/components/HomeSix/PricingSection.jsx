...
function PricingSection() {
    return (
        <section className="home6-pricing-section s-padding">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="pricing-t-s6 pricing-t-s1">
                            <div className="pt-header">
                                <div className="icon">
                                    <img
                                        src="/assets/images/feature-icons/development-icon2.svg"
                                        alt=""
                                    />
                                </div>
                                <div className="price">
                    ...
                    /></span>
                            ...
                            <div className="pt-footer">
                                <Link href="/pricing" className="pt-btn btn btn-s6">Buy Now</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="pricing-t-s6 pricing-t-s1 active floating">
                            <div className="pt-header">
                                <div className="icon">
                                    <img
                                        src="/assets/images/feature-icons/development-icon2.svg"
