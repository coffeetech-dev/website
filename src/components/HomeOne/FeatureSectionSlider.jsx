                    ...
                    <SliderCom settings={settings}>
                        <div className="col-xl-4">
                            <div className="feature-s5">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/feature5-1.png" alt=""/>
                                </div>
                                <div className="content">
                                    ...
                                    <h3><Link href="/service-details">Network Protection</Link></h3>
                                    <p>
                        ...
                        <div className="col-xl-4">
                            <div className="feature-s5">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/feature5-2.webp" alt=""/>
                                </div>
                                <div className="content">
                                    <div className="icon">
                                        <img
                                    ...
                                    <h3><Link href="/service-details">Product Development</Link></h3>
                                    <p>
                                        There are many variatons of passag es of Lorem Ipsum
                                        available, but the majority have suffered
                                    </p>
                        ...
                        <div className="col-xl-4">
                            <div className="feature-s5">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/feature5-3.png" alt=""/>
                                </div>
                                <div className="content">
                                    <div className="icon">
                                        <img
                                    ...
                                    <h3><Link href="/service-details">Digital Marketing</Link></h3>
                                    <p>
                                        There are many variatons of passag es of Lorem Ipsum
                                        available, but the majority have suffered
                                    </p>
                        ...
                        <div className="col-xl-4">
                            <div className="feature-s5">
                                ...
                                <div className="content">
                                    ...
                                    <h3><Link href="/service-details">User Research</Link></h3>
                                    <p>
                                        There are many variatons of passag es of Lorem Ipsum
                                        available, but the majority have suffered
                                    </p>
                        ...
                        <div className="col-xl-4">
                            <div className="feature-s5">
                                ...
                                <div className="content">
                                    ...
                                    <h3><Link href="/service-details">SEM Research</Link></h3>
                                    <p>
                                        There are many variatons of passag es of Lorem Ipsum
                                        available, but the majority have suffered
                                    </p>
