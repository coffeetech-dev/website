                    ...
                    <SliderCom settings={settings}>
                        <div className="col-lg-3">
                            <div className="single-team-s1">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/team-1.png" alt=""/>
                        ...
                        <div className="col-lg-3">
                            <div className="single-team-s1">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/team-2.png" alt=""/>
                                    <ul className="social-icons-s1">
                                        <li style={{'--delay':'--delay: 0s'}}>
                                            <Link href="https://www.facebook.com/QuomodoSoft"
                                            ><i className="fa-brands fa-facebook-f"></i
                        ...
                        <div className="col-lg-3">
                            <div className="single-team-s1">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/team-3.png" alt=""/>
                                    <ul className="social-icons-s1">
                                        <li style={{'--delay':'--delay: 0s'}}>
                                            <Link href="https://www.facebook.com/QuomodoSoft"
                                            ><i className="fa-brands fa-facebook-f"></i
                        ...
                        <div className="col-lg-3">
                            <div className="single-team-s1">
                                <div className="thumb">
                                    <img src="/assets/images/thumbs/team-4.png" alt=""/>
                                    <ul className="social-icons-s1">
                                        <li style={{'--delay':'--delay: 0s'}}>
                                            <Link href="https://www.facebook.com/QuomodoSoft"
                                            ><i className="fa-brands fa-facebook-f"></i
