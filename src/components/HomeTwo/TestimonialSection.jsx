...
function TestimonialSection() {
    ...
    return (
        <section className="testimonial-area-s2 s-padding-b">
                ...
                <div className="row">
                    <div className="col-xl-6">
                        <div className="testimonial-area-s1__thumb floating">
                            <img src="/assets/images/thumbs/tes-area-2-thumb.png" alt=""/>
                        </div>
                    </div>
                    <div className="col-xl-6">
                                    ...
                                    <div className="single-tes-s2">
                                        <div className="icon-rating">
                                            <div className="q-icon">
                                                <img
                                                    src="/assets/images/feature-icons/quote-icon-1.svg"
                                                    alt=""
                                                />
                                            </div>
                                        ...
                                        <p className="desc">
                                            ...
                                            randomised words which a dont look even slightly
                                            believable.
                                        </p>
                                        <div className="auth-info">
                                            <div className="thumb">
                                                <img src="/assets/images/thumbs/tes-thumb-2.png" alt=""/>
                                            </div>
            ...
            <div className="shape">
                <img src="/assets/images/backgrounds/glowing-shape-2.png" alt=""/>
            </div>
        </section>
    );
}
